...
- **03_architecture_deploiement.md** : Peut attendre (détails techniques)
...
- **02_index_optimisation.md** : Peut attendre (optimisation = implémentation)
- **03_fonctions_sql.md** : Peut attendre (détails d'implémentation)
- **04_fonctions_sql_implementation.sql** : À faire pendant l'implémentation
...
- **03_plan_gantt_projet.md** : Peut être fait maintenant (planification)

### 10_documentation_integrations/
- **01_integration_odoo.md** : Spécifications = conception, détails techniques = implémentation
- **02_integration_stripe.md** : Idem
...
- **01_politique_securite.md** : Politique générale = conception, détails techniques = implémentation
...
│ ├── 02_index_optimisation.md (plus tard)
│ ├── 03_fonctions_sql.md (plus tard)
│ └── 04_fonctions_sql_implementation.sql (plus tard)
└── 15_glossaire_et_references/ 
